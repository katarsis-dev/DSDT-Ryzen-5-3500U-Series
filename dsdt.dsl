...
DefinitionBlock ("", "DSDT", 2, "ALASKA", "A M I ", 0x1072009A)
{
    ...
    External (_PR_.P004.PPCV, UnknownObj)
    External (_PR_.P005.PPCV, UnknownObj)
    External (_PR_.P006.PPCV, UnknownObj)
    External (_PR_.P007.PPCV, UnknownObj)
    ...
    Name (DTPT, Zero)
    Name (TTDP, One)
    Name (TPMB, 0xDCF93000)
    Name (TPBS, 0x4000)
    Name (TPMC, 0xDCF97000)
    Name (TPCS, 0x4000)
    Name (TPMM, 0xFD110510)
    Name (FTPM, 0xFD110510)
    Name (PPIM, 0xDD266F98)
    Name (PPIL, 0x1C)
    Name (AMDT, One)
    Name (TPMF, One)
    Name (PPIV, One)
    ...
    Name (RDHW, Zero)
    Name (CNSB, Zero)
    Name (CRBR, 0xDD266018)
    OperationRegion (CRBN, SystemMemory, CRBR, 0x0C)
    ...
    Scope (_SB)
    {
        Device (PCI0)
        {
            ...
            Method (_OSC, 4, Serialized)  // _OSC: Operating System Capabilities
            {
                ...
                If ((Arg0 == ToUUID ("0") /* PCI Host Bridge Device */))
                {
            ...
            Device (D003)
            {
                ...
                Scope (\)
                {
                    ...
                    Method (PWAK, 1, Serialized)
                    {
                        ...
                        If ((\_SB.PCI0.SBRG.EC0.ACST == Zero))
                        {
                            Sleep (0x14)
                            \_SB.PCI0.SBRG.EC0.LITS (0x03, 0x04)
                            If ((\_SB.PCI0.SBRG.EC0.BRSC <= 0x14))
                            {
                                PPCT (One)
                            }
                        }
                        ElseIf ((\_SB.PCI0.SBRG.EC0.BATP == Zero))
                        {
                            Sleep (0x14)
                            \_SB.PCI0.SBRG.EC0.LITS (0x03, 0x04)
                            SMB2 = 0xCA
                        ...
                        Else
                        {
                            ...
                            Else
                            {
                                \_SB.PCI0.SBRG.EC0.LITS (0x03, 0x06)
                                SMB2 = 0xCB
                                PPCT (Zero)
                            }
                        }
                ...
                Scope (\_SB)
                {
                    Device (BTNS)
                    {
                        ...
                        Name (_CRS, ResourceTemplate ()  // _CRS: Current Resource Settings
                        {
                            GpioInt (Edge, ActiveBoth, Exclusive, PullNone, 0x0BB8,
                        ...
                        {
                            ToUUID ("0") /* Generic Buttons Device */, 
                            Package (0x02)
                            {
                                Package (0x05)
                                {
    ...
    Scope (_SB.TPM)
    {
        ...
        {
            If ((Arg0 == ToUUID ("0") /* Physical Presence Interface */))
            {
            ...
            ElseIf ((Arg0 == ToUUID ("0") /* Unknown UUID */))
            {
                Switch (ToInteger (Arg2))
                {
                    Case (Zero)
    ...
    Scope (_SB.I2CD)
    {
        Device (TPAD)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                Return (RBUF) /* \_SB_.I2CD.TPAD._CRS.RBUF */
            }
            ...
            Method (_DSM, 4, Serialized)  // _DSM: Device-Specific Method
            {
                If ((Arg0 == ToUUID ("0") /* HID I2C Device */))
                {
                    Switch (ToInteger (Arg2))
                    {
                        Case (Zero)
    ...
    Scope (_SB)
    {
        Device (BAT0)
        {
            ...
            Method (SBIX, 0, Serialized)
            {
                ...
                BIFP [0x02] = Local0
                BIXP [0x03] = Local0
                Local0 = ^^PCI0.SBRG.EC0.BCTH /* \_SB_.PCI0.SBRG.EC0_.BCTH */
                Local2 = ^^PCI0.SBRG.EC0.BCTL /* \_SB_.PCI0.SBRG.EC0_.BCTL */
                Local1 = (Local0 * 0x0100)
                Local0 = (Local1 + Local2)
                ...
                BIFP [0x06] = ((Local0 * 0x0A) / 0xFA)
                BIXP [0x07] = ((Local0 * 0x0A) / 0xFA)
                ...
                Device (PRT3)
                {
                    ...
                    Device (FCAM)
                    {
                        ...
                        Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                        {
                            ...
                            Return (PLDP) /* \_SB_.PCI0.GP17.XHC0.RHUB.PRT5.PRT3.FCAM._PLD.PLDP */
                        }
                    }
                }
        ...
        Device (RHUB)
        {
            ...
            Device (PRT1)
            {
                ...
                Device (POR3)
                {
                    ...
                    {
                        Return (UPC1) /* \_SB_.PCI0.GP17.XHC1.RHUB.PRT1.POR3.UPC1 */
                    }
                    ...
                    Name (PLD1, Package (0x01)
                    {
                        ...
                        {
                            /* 0000 */  0x82, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                            /* 0008 */  0x40, 0x08, 0x06, 0x00, 0x01, 0x00, 0x00, 0x00,  // @.......
                            /* 0010 */  0xFF, 0xFF, 0xFF, 0xFF                           // ....
                        }
                    })
                    Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                    {
                        Return (PLD1) /* \_SB_.PCI0.GP17.XHC1.RHUB.PRT1.POR3.PLD1 */
                    }
                    ...
                    Device (FCAM)
                    {
                        ...
                        Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                        {
                            Return (UPC2) /* \_SB_.PCI0.GP17.XHC1.RHUB.PRT1.POR3.FCAM.UPC2 */
                        }
                        ...
                        Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                        {
                            Return (PLD2) /* \_SB_.PCI0.GP17.XHC1.RHUB.PRT1.POR3.FCAM.PLD2 */
                        }
                    }
                }
    ...
    Method (PPCT, 1, Serialized)
    {
        \_PR.P000.PPCV = Arg0
        \_PR.P001.PPCV = Arg0
        \_PR.P002.PPCV = Arg0
        \_PR.P003.PPCV = Arg0
        If (((RV2I == Zero) && (FLTY == Zero)))
        {
            If ((NUMC == 0x08))
            {
                \_PR.P004.PPCV = Arg0
